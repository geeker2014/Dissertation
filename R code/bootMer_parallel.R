...
### bootMer_parallel() --- <==>  (TODO: semi-*)parametric bootstrap
### -------------------------------------------------------
...
##'
##' The working name for bootMer_parallel() was \dQuote{simulestimate()}, as it is an
...
##' system.time( boo01 <- bootMer_parallel(fm01ML, mySumm, nsim = 100) )
##'
##' ## to "look" at it
